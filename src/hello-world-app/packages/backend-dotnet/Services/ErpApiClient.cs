...
{
    public async Task<HttpResponseMessage> ForwardAsync(ErpProxyRequest request, string method, CancellationToken cancellationToken)
    {
        ...
        outboundRequest.Headers.Add("X-Tenant-ID", request.TenantId);
