...
function GraphQlExplorerPanel() {
  ...
  if (errorMessage) {
    return <Alert title="GraphQL schema could not be loaded" description={errorMessage} variant="destructive" closable={false} />;
  }

  if (!graphQlSchemaObject) {
    return (
      <Alert
...
export default GraphQlExplorerPanel;
